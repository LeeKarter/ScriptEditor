...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        loadButton->setGeometry(QRect(10, 510, 90, 29));
        saveButton = new QPushButton(centralwidget);
        saveButton->setObjectName(QString::fromUtf8("saveButton"));
        saveButton->setGeometry(QRect(120, 510, 90, 29));
        editor = new QPlainTextEdit(centralwidget);
        editor->setObjectName(QString::fromUtf8("editor"));
        editor->setGeometry(QRect(10, 10, 781, 481));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Script editor", nullptr));
